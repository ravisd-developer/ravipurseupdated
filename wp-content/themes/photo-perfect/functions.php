...
function photo_perfect_scripts() {
  ...
  wp_enqueue_style( 'photo-perfect-fontawesome', get_template_directory_uri() . '/third-party/font-awesome/css/font-awesome.min.css', '', '4.4.0' );

  wp_enqueue_style( 'photo-perfect-google-fonts-arizonia', '//fonts.googleapis.com/css?family=Arizonia' );

  wp_enqueue_style( 'photo-perfect-google-fonts-open-sans', '//fonts.googleapis.com/css?family=Open+Sans:600,400,300,100,700' );

  wp_enqueue_style( 'photo-perfect-photobox-css', get_template_directory_uri() . '/third-party/photobox/photobox.css', array(), '1.6.3' );

	wp_enqueue_style( 'photo-perfect-style', get_stylesheet_uri(), array( 'photo-perfect-fontawesome', 'photo-perfect-google-fonts-arizonia', 'photo-perfect-google-fonts-open-sans' ) );
